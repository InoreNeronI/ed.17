...
[ -d "${PUBLIC_SRC}/scripts/jquery" ] || mkdir "${PUBLIC_SRC}/scripts/jquery"
cp -rv ./node_modules/jquery/dist/jquery.* ${PUBLIC_SRC}/scripts/jquery
[ -d "${PUBLIC_SRC}/scripts/jquery-resize" ] || mkdir "${PUBLIC_SRC}/scripts/jquery-resize"
...
[ -d "${PUBLIC_SRC}/images/jquery-resize" ] || mkdir "${PUBLIC_SRC}/images/jquery-resize"
